...
public class ItemShick extends ItemTool
{
    ...
    {
        return blockIn == Blocks.snow_layer ? true : blockIn == Blocks.snow && blockIn == Blocks.obsidian ? this.toolMaterial.getHarvestLevel() == 3 : blockIn == BlockMod.neliumore ? this.toolMaterial.getHarvestLevel() >= 2 : blockIn == BlockMod.sarliteore ? this.toolMaterial.getHarvestLevel() >= 3 : blockIn == BlockMod.flamiteore ? this.toolMaterial.getHarvestLevel() >= 3 : blockIn == BlockMod.illiwonore ? this.toolMaterial.getHarvestLevel() >= 4 : blockIn == BlockMod.afnamiteore ? this.toolMaterial.getHarvestLevel() >= 5 : blockIn == BlockMod.endermiteore ? this.toolMaterial.getHarvestLevel() >= 6 : blockIn == BlockMod.endendermiteore ? this.toolMaterial.getHarvestLevel() >= 6 : (blockIn != Blocks.diamond_block && blockIn != Blocks.diamond_ore ? (blockIn != Blocks.emerald_ore && blockIn != Blocks.emerald_block ? (blockIn != Blocks.gold_block && blockIn != Blocks.gold_ore ? (blockIn != Blocks.iron_block && blockIn != Blocks.iron_ore ? (blockIn != Blocks.lapis_block && blockIn != Blocks.lapis_ore ? (blockIn != Blocks.redstone_ore && blockIn != Blocks.lit_redstone_ore ? (blockIn.getMaterial() == Material.rock ? true : (blockIn.getMaterial() == Material.iron ? true : blockIn.getMaterial() == Material.anvil)) : this.toolMaterial.getHarvestLevel() >= 2) : this.toolMaterial.getHarvestLevel() >= 1) : this.toolMaterial.getHarvestLevel() >= 1) : this.toolMaterial.getHarvestLevel() >= 2) : this.toolMaterial.getHarvestLevel() >= 2) : this.toolMaterial.getHarvestLevel() >= 2);
    }
