...
public class WorldGenRedwoodTrees extends WorldGenTrees
{
    ...
    public WorldGenRedwoodTrees(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 16, 0, 0, false);
    }

    public WorldGenRedwoodTrees(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_3_, int p_i2028_4_, boolean p_i2028_5_)
    {
        super(p_i2028_1_);
