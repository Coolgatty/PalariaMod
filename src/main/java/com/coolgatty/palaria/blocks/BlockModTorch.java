...
import com.coolgatty.palaria.particles.Particles;
...
public class BlockModTorch extends Block
{
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (enumfacing.getAxis().isHorizontal())
        {
            ...
            Particles.spawnParticle("NELIUM_FLAME", d0 + d4 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D);
        }
        else
        {
            worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
            Particles.spawnParticle("NELIUM_FLAME", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
