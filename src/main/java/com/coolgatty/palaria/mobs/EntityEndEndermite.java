...
public class EntityEndEndermite extends EntityMob
{
    ...
    public EntityEndEndermite(World worldIn)
    {
        super(worldIn);
        ...
        this.targetTasks.addTask(2, new EntityEndEndermite.AIFindPlayer());
    ...
    class AIFindPlayer extends EntityAINearestAttackableTarget
    {
        ...
        private EntityEndEndermite field_179449_j = EntityEndEndermite.this;
        private static final String __OBFID = "CL_00002221";

        public AIFindPlayer()
        {
            super(EntityEndEndermite.this, EntityPlayer.class, true);
        }
        ...
        public void resetTask()
        {
            ...
            iattributeinstance.removeModifier(EntityEndEndermite.attackingSpeedBoostModifier);
            super.resetTask();
        }
        ...
        public void updateTask()
        {
            if (this.field_179448_g != null)
            {
                if (--this.field_179450_h <= 0)
                {
                    ...
                    IAttributeInstance iattributeinstance = this.field_179449_j.getEntityAttribute(SharedMonsterAttributes.movementSpeed);
                    iattributeinstance.applyModifier(EntityEndEndermite.attackingSpeedBoostModifier);
                }
            }
            else
            {
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(Palaria.endermiteshard.itemID, 2);
        }*/
    }
}
